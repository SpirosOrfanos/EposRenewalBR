package gr.epos.renewal.br.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("EposRenewalBR");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("EposRenewalBR");
        ...
        config.getMapConfigs().put("gr.epos.renewal.br.domain.*", initializeDomainMapConfig(jHipsterProperties));
